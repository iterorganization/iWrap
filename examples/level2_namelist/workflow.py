...
from physics_ii_fortran_namelist.actor import physics_ii_fortran_namelist
from physics_ii_fortran_namelist.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.actor_physics_ii = physics_ii_fortran_namelist()
