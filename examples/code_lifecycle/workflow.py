...
from code_lifecycle.actor import code_lifecycle
from code_lifecycle.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.actor_code_lifecycle = code_lifecycle()
