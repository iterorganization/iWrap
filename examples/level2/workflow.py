...
from physics_ii_fortran_xml.actor import physics_ii_fortran_xml
from physics_ii_fortran_xml.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.actor_physics_ii = physics_ii_fortran_xml()
