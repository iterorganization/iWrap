...
from dask_fortran.actor import dask_fortran
from dask_fortran.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.dask_fortran = dask_fortran()
    ...
    def init_workflow(self):
        ...
        self.input_entry2 = imas.DBEntry(imas.imasdef.MDSPLUS_BACKEND,input_database,shot2,run_in2,input_user_or_path)
        self.input_entry2.open()
        ...
        runtime_settings = self.dask_fortran.get_runtime_settings()
        runtime_settings.run_mode = RunMode.STANDALONE
        #runtime_settings.debug_mode = DebugMode.STANDALONE

        code_parameters = self.dask_fortran.get_code_parameters()

        input_core_profiles = self.input_entry2.get('core_profiles')
        self.distribution_sources = self.dask_fortran.initialize(input_core_profiles, runtime_settings=runtime_settings, code_parameters=code_parameters)
    ...
    def execute_workflow(self):
        ...
        output_equilibrium_delayed = dask.delayed( self.dask_fortran.run )( input_equilibrium )
        output_equilibrium = output_equilibrium_delayed.compute()
    ...
    def end_workflow(self):
        ...
        # Finalize ALL actors 
        out_core_profiles = self.dask_fortran.finalize(self.distribution_sources)
        str( out_core_profiles.time )
