...
from UpperCase.actor import UpperCase
from UpperCase.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.actor_UpperCase = UpperCase()
    ...
    def init_workflow(self):
        ...
        if actor_run_mode == 'STANDALONE':
            ...
            runtime_settings = self.actor_UpperCase.get_runtime_settings()
            runtime_settings.run_mode = RunMode.STANDALONE

        code_parameters = self.actor_UpperCase.get_code_parameters()
        self.actor_UpperCase.initialize(runtime_settings=runtime_settings, code_parameters=code_parameters)
    ...
    def execute_workflow(self):
        ...
        output_equilibrium = self.actor_UpperCase(input_equilibrium)
