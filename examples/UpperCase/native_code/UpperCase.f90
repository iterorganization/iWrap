...
contains
    ...
    !
    subroutine InitCode (xml_parameters, status_code, status_message)
    ...
    end subroutine InitCode


    !
    !    FINALISATION SUBROUTINE
    !
    subroutine CleanUp(status_code, status_message)
        implicit none
        integer, intent(out) :: status_code
        character(len=:), pointer, intent(out) :: status_message
    ...
    !    MAIN SUBROUTINE
    !
    subroutine UpperCase(equilibrium_in, equilibrium_out, xml_parameters, status_code, status_message)
        ...
        if (ids_is_valid(equilibrium_in%ids_properties%homogeneous_time).eqv..True. &
            ...
            equilibrium_out%code%name(1)   = 'EXAMPLE: UpperCase'
            ...
            equilibrium_out%code%parameters(1) = 'EXAMPLE: UpperCase: NO PARAMETERS'
