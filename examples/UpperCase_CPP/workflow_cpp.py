...
from UpperCase_CPP.actor import UpperCase_CPP

from UpperCase_CPP.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.actor_code_lifecycle = UpperCase_CPP()
