...
from basic_methods_cpp.actor import basic_methods_cpp
from basic_methods_cpp.common.runtime_settings import RunMode, DebugMode
...
class ExampleWorkflowManager:
    ...
    def __init__(self):
        ...
        self.basic_methods_cpp = basic_methods_cpp()
    ...
    def init_workflow(self):
        ...
        if actor_run_mode == 'STANDALONE':
            ...
            runtime_settings = self.basic_methods_cpp.get_runtime_settings()
            runtime_settings.run_mode = RunMode.STANDALONE

        code_parameters = self.basic_methods_cpp.get_code_parameters()

        input_core_profiles = self.input_entry2.get('core_profiles')
        self.distribution_sources = self.basic_methods_cpp.initialize(input_core_profiles, runtime_settings=runtime_settings, code_parameters=code_parameters)
    ...
    def execute_workflow(self):
        ...
        output_equilibrium = self.basic_methods_cpp(input_equilibrium)
    ...
    def end_workflow(self):
        ...
        # Finalize ALL actors 
        out_core_profiles = self.basic_methods_cpp.finalize(self.distribution_sources)
