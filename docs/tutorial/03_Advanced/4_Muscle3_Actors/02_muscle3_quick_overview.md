...
MUSCLE3 is a coupling library developed by the e-MUSC project of the University of Amsterdam and the Netherlands eScience Center. It is designed for building multiscale simulations by integrating single-scale models into a cohesive framework. To learn more, visit [MUSCLE3 official documentation](https://muscle3.readthedocs.io/en/latest/), [yMMSL specification](https://ymmsl-python.readthedocs.io/en/master/) and [iWrap MUSCLE3 plugin documentation](https://iwrap.readthedocs.io/en/latest/documentation/muscle3_resources/code_wrapping.html)
