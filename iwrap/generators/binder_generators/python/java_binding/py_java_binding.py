...
class JavaBinderGenerator( BinderGenerator ):
    # Class logger
    ...
    def generate(self, project_settings: dict):
        ...
        process_template_dir('iwrap.generators.binder_generators.python.java_binding', 'resources', self.install_dir, project_settings, filter_func=filter_func, output_stream= self.__info_output_stream, )
