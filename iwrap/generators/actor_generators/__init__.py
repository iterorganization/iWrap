...
class ActorGeneratorRegistry:
    ...
    def initialize(cls):
        cls.__generators = utils.discover_generators(
            cls.__builtin_pkg_name, cls.__plugin_pkg_name, ActorGenerator
        )
    ...
    def get_generator(cls, generator_type) -> ActorGenerator:
        ...
        raise ValueError(
            f'ERROR: No registered generator for provided actor type <{generator_type}>! Registered generators: "{types}".'
        )
