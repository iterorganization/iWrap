...
class FortranPAFActorGenerator(ActorGenerator):
    # Class logger
    ...
    def description(self) -> str:
        return "Wrapping Fortran code into MUSCLE3 micro model"
    ...
    def __init__(self):
        ...
        self.skeleton_generation = False
