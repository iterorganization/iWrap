...
class OtherPane(tkinter.ttk.Frame, IWrapPane):
    ...
    def __init__(self, master=None):
        ...
        labelframe.pack(
            fill=tkinter.BOTH, side=tkinter.BOTTOM, expand=1, anchor=tkinter.NW, pady=10
        )
        labelframe.grid_columnconfigure(1, weight=1)
        # get_state
        tkinter.ttk.Label(labelframe, text="Get state:").grid(
        ...
        # set_state
        tkinter.ttk.Label(labelframe, text="Set state:").grid(
        ...
        # get_timestamp
        tkinter.ttk.Label(labelframe, text="Get timestamp:").grid(
            column=0, row=3, padx=10, pady=5, sticky=(tkinter.W, tkinter.N)
        )
    ...
    def update_settings(self, *args):
        ...
        code_description.implementation.subroutines.get_timestamp = (
            self.get_timestamp.get()
        )
    ...
    def reload(self):
        ...
        self.get_timestamp.set(
            code_description.implementation.subroutines.get_timestamp or ""
        )
